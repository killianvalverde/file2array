...
/**
 * @file        file2array/exception.hpp
 * @brief       exception class header.
 * @author      Killian Valverde
 * @date        2024/10/25
 */

#ifndef FILE2ARRAY_EXCEPTION_HPP
#define FILE2ARRAY_EXCEPTION_HPP
...
/**
 * @brief       Base interface for standard file2array exceptions. All objects thrown 
 *              by components file2array are derived from this class. Therefore, all 
 *              file2array exceptions can be caught by catching this type by reference.
 */
...
/**
 * @brief       Base class that the file2array classes will use to throw exceptions.
 */
